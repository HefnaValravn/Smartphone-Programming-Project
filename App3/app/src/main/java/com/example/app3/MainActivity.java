...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.fabCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getApplicationContext(), "This is the Homepage", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void hideFabCall(View v){
        binding.fabCall.hide();
    }

    public void showFabCall(View v){
        binding.fabCall.show();
    }
